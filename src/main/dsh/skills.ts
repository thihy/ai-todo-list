...
export const SKILLS: DshSkill[] = [
  {
    ...
    tools: ['todo_list', 'todo_get', 'todo_search', 'todo_stats', 'todo_create', 'todo_update', 'todo_delete', 'todo_restore'],
    promptFragment: '你可以读取和修改用户的 TODO；删除是逻辑删除（可恢复），恢复用 todo_restore。',
  ...
  },
  {
    ...
    tools: ['content_readBody', 'content_writeBody', 'content_history', 'content_restoreVersion'],
  ...
  },
  {
    ...
    tools: ['drawing_list', 'drawing_read', 'drawing_save', 'drawing_delete', 'drawing_setThumb'],
  ...
  },
  {
    ...
    tools: ['todo_list', 'todo_stats', 'todo_search'],
